package saucelab.test.pageObject;
...
public class SerenitySaucelabTest_PageObject extends PageObject {
	...
	public void click_startUserRegistration() {
		WebElement startUserRegistration1 = getDriver()
				.findElement(By.id("io.selendroid.testapp:id/startUserRegistration"));
